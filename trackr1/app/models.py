...
class HealthLog(models.Model):
    ...
    target_water_intake = models.FloatField(null=True, blank=True)
    target_sleep = models.FloatField(null=True, blank=True)
    target_steps = models.PositiveIntegerField(null=True, blank=True)
